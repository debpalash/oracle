...
DEFAULT_INSTALL_DIR = os.path.expanduser(os.path.join('~', '.oracle-cli/lib', 'oracle-cli'))
DEFAULT_EXEC_DIR = os.path.expanduser(os.path.join('~', '.oracle-cli/bin'))
DEFAULT_SCRIPT_DIR = os.path.expanduser(os.path.join('~', '.oracle-cli/bin', 'oci-cli-scripts'))
